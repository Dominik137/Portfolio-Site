...
const navigate = useNavigate()
  ...
  <ul style={{paddingRight: '15px'}}>
    <li>
      <a target="_blank" href="https://github.com/Dominik137" style={{ color: 'white', fontSize: '' }}  >
    ...
    <li>
      <a href="https://www.linkedin.com/in/dominik-arment-579a39265/" target="_blank" style={{ color: 'white'}}>
